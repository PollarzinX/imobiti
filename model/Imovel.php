...
class Imovel
{
    ...
    public function __set(string $prop, $valor)
    {
        if (property_exists($this, $prop)) {
            ...
            throw new Exception("Propriedade {$prop} não existe para atribuição.");
        }
    } // <-- CHAVES FECHADAS AQUI (Correção)
    ...
    public function salvar()
    {
        ...
        // CORREÇÃO: Variável $res recebe o resultado do execute()
...
try {
    // Nota: O uso de named arguments requer PHP 8.0 ou superior
    $imovel = new Imovel(
        id: 0,
        titulo: "Casa de Luxo no Parque do Carmo",
        tipo: "Casa",
        tipo_negocio: "Venda",
        descricao: "Maravilhosa casa localizada no pq do Carmo",
        preco: 10000000.50,
        valor_condominio: 0.00, // Ajustado para ser explicitamente float
        valor_iptu: 5000.00,
        cep: "08450-000",
        cidade: "São Paulo",
        bairro: "Itaquera",
        ...
        slug: "casa-no-pq-do-carmo"
    );

    // Salva o imóvel e imprime "1" se der tudo certo (true em boolean no echo)
    echo $imovel->salvar() ? "Imóvel salvo com sucesso! ID: " . $imovel->id : "Falha ao salvar.";
} catch (Exception $e) {
