...
<head>
    ...
    <title>Cadastro de Imóvel - Administração</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="menu">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="admin_lista_imoveis.html">Imóveis</a></li>
            ...
            <form id="formImovel" method="POST" action="../controller/Imovel.php" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="titulo" class="form-control" placeholder="Ex: Casa de Luxo com 3 suítes" required>
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="descricao" rows="4" class="form-control" placeholder="Detalhes sobre o imóvel, acabamentos, diferenciais..."></textarea>
                </div>
 
                <!-- VALORES E FINANCEIRO -->
                <h5 class="section-title mt-4"><i class="bi bi-cash-stack me-2"></i>Valores e Financeiro</h5>
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Preço de Venda/Aluguel (R$)</label>
                        <input type="number" step="0.01" name="preco" class="form-control" placeholder="0.00" required>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Valor Condomínio (R$)</label>
                        <input type="number" step="0.01" name="valor_condominio" class="form-control" placeholder="Se houver">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Valor IPTU (R$)</label>
                        <input type="number" step="0.01" name="valor_iptu" class="form-control" placeholder="Anual ou mensal">
                    </div>
                </div>
 
                <!-- CARACTERÍSTICAS -->
                <h5 class="section-title mt-4"><i class="bi bi-house-gear me-2"></i>Características</h5>
                <div class="row align-items-end">
                    <div class="col-md-2 mb-3">
                        <label class="form-label">Quartos</label>
                        <input type="number" name="quartos" class="form-control" min="0">
                    </div>
 
                    <div class="col-md-2 mb-3">
                        <label class="form-label">Banheiros</label>
                        <input type="number" name="banheiros" class="form-control" min="0">
                    </div>
 
                    <div class="col-md-2 mb-3">
                        <label class="form-label">Vagas Garagem</label>
                        <input type="number" name="vagas" class="form-control" min="0">
                    </div>
                    ...
                    <div class="col-md-4 mb-3 pb-2">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="possui_piscina" id="piscina">
                            <label class="form-check-label" for="piscina">Piscina</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="possui_churrasqueira" id="churrasqueira">
                ...
                <!-- LOCALIZAÇÃO -->
                <h5 class="section-title mt-4"><i class="bi bi-geo-alt me-2"></i>Localização</h5>
                <div class="row">
                    <div class="col-md-2 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="endereco" class="form-control" placeholder="Rua, Av, Praça...">
                    </div>
                    <div class="col-md-4 mb-3">
                ...
                <!-- GESTÃO E MÍDIA -->
                <h5 class="section-title mt-4"><i class="bi bi-camera me-2"></i>Gestão e Mídia</h5>
                <div class="row">
                    <div class="col-md-3 mb-3">
                        <label class="form-label">Corretor Responsável</label>
                        <select name="id_corretor" class="form-select" required>
                            <option value="">Selecione...</option>
                            <option value="1">Corretor João Silva</option>
                            <option value="2">Corretora Maria Oliveira</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Upload de Fotos</label>
                        <input type="file" name="fotos[]" id="inputFotos" multiple class="form-control" accept="image/*">
                        <small class="text-muted">Selecione uma ou mais fotos para o imóvel.</small>
                    </div>
                </div>
 
                <!-- Contentor de Pré-visualização e Seleção de Destaque -->
                <div id="containerPreview" class="mt-3 d-none">
                    <p class="form-label mb-2">Selecione qual foto será o <strong>Destaque</strong>:</p>
                    <div id="listaFotosPreview" class="row g-3">
                ...
                <div class="d-flex justify-content-end gap-3 mt-5 border-top pt-4">
                    ...
                    <button type="submit" class="btn btn-lg btn-primary px-5">Cadastrar Imóvel</button>
                </div>
